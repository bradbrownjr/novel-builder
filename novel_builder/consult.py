...
def build_voice_casting_prompt(char_yaml, voice_catalog_text, available_voices, outline_context=None):
    ...
    system = (
        ...
        "2. **English voices only** -- This story is written in English. You MUST "
        "ONLY recommend voices from the American (af_*, am_*) or British "
        "(bf_*, bm_*) accent groups. ALL other accent groups (Japanese jf_*/jm_*, "
        "Chinese zf_*/zm_*, Korean, French, Hindi, Italian, etc.) speak their "
        "native language -- they will produce unintelligible output for English text. "
        "NEVER recommend a non-English voice regardless of character origin.\n\n"
        "3. **Accent within English voices** -- For English-language characters, "
        "match accent: British/Irish/Scottish/Australian origin -> British voices "
        "(bf_*, bm_*); American/Canadian/default -> American voices (af_*, am_*). "
        "For characters with non-English origin (Japanese, Asian, French, etc.) "
        "in an English-language story, choose the best-fitting American or British "
        "voice based on personality, age, and tone -- accent-matching does not apply.\n\n"
    ...
    user = (
        ...
        f"Only use American (af_*, am_*) or British (bf_*, bm_*) voices -- all other "
        f"accent groups speak non-English and will not work.\n\n"
        f"{narrator_task}"
