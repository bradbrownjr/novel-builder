...
def call_summary_model(host, model, text, timeout=300, scene_meta=None,
    ...
    system_prompt = (
        ...
        "- ACTIONS: Only consequential plot actions — decisions made, confrontations, "
        "  discoveries, betrayals. Do NOT extract routine job duties (cataloging, "
        "  sorting, shelving, cleaning, arranging, maintaining inventory) even if "
        "  performed in this scene. NOT 'walked across room', 'poured coffee', "
        "  'continued working', or 'organised the display'.\n"
        "- COMMITMENTS: Only NEW obligations or plans introduced in THIS scene that "
        "  have clear future consequences. Do NOT re-extract ongoing background duties "
        "  (a character cataloging inventory, sorting stock, maintaining displays). "
        "  If this same obligation has likely existed in previous scenes, write NONE.\n"
